...
<div align="center">
	<table>
		<tr>
			<td class="tg-031e">제  목</td>
			<td class="tg-031e" colspan="2"><input type="text" size="80" name='title'
			 value="${complainVO.title}" readonly="readonly"></td>
		</tr>
		<tr>
			<td class="tg-031e">내  용</td>
			<td class="tg-031e" colspan="2"><textarea class="form-control" name="content" cols="80" rows="3"
			readonly="readonly">${complainVO.content}</textarea></td>
		</tr>
		<tr>
			<td class="tg-031e">작 성 자</td>
			<td class="tg-031e" colspan="2"><input type="text" size= "80" name="uid" 
			class="form-control" value="${complainVO.uid}" readonly="readonly"></td>
		</tr>
		<tr>
			<td class="tg-031e">답  변</td>
			<td class="tg-031e"><script>
							...
							document.write('<form action="/complain/inReply" method="post">' +
									...
									'<input type="text" size="70" name="reply" class="form-control" id="reply"> &nbsp &nbsp' +
								...
								document.write('<form action="/complain/outReply" method="post">' +								
									'<input type="hidden" name="complainNum" value="${complainVO.complainNum}">' + 
									'<input type="text" size="70" name="uid" class="form-control"'+ 
									'value="${complainVO.reply}"readonly="readonly">&nbsp &nbsp' +
									'<button type="submit" class="w3-btn w3-white w3-border "> 답변 삭제 </button>' +
									'</form>'
								);
							}
			</script></td>
